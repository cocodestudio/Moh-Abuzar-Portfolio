      ...
      <div className="w-full md:my-auto max-w-7xl mx-auto flex flex-col gap-4 md:gap-5 lg:gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3.5 md:gap-4 lg:gap-4.5 pt-2 border-t border-[#e4e4e7]">
          {milestones.map((m) => (
            <div
              key={m.year}
              className="touch-card card-3d card-3d-shine p-4 sm:p-4.5 lg:p-5 rounded-2xl bg-white border border-[#e4e4e7] hover:border-[#ff4502]/50 hover:shadow-md transition-all duration-300 flex flex-col justify-between group"
            >
              <div>

    ...
    >
      <div className="my-auto w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 lg:gap-10 items-center">
        ...
        <div className="md:col-span-7 flex flex-col items-start text-left z-10">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-3xl lg:text-5xl xl:text-6xl font-semibold tracking-[-0.03em] leading-[1.1] text-[#18181b] mb-4 lg:mb-6">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-[#71717a] font-normal leading-relaxed max-w-xl mb-2 lg:mb-4">
        ...
        <div className="md:col-span-5 flex justify-center items-center relative select-none mt-2 md:mt-0">
          ...
          <div
            ...
            className="relative w-full max-w-[260px] sm:max-w-[320px] md:max-w-[300px] lg:max-w-[360px] h-[320px] sm:h-[380px] md:h-[40vh] lg:h-[460px] max-h-[480px] flex items-end justify-center cursor-pointer group water-wave-hover"
          >
